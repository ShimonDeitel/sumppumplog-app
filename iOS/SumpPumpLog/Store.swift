...
final class Store: ObservableObject {
    ...
    init() {
        ...
        fileURL = supportDir.appendingPathComponent("sumppumplog_entries.json")
        settingsURL = supportDir.appendingPathComponent("sumppumplog_settings.json")
        load()
    }
    ...
    private func seedIfNeeded() {
        ...
        entries = [
        CheckEntry(dateISO: "2025-05-01", status: "Working - battery tested OK", notes: "Ran backup for 10 min, no issues"),
        CheckEntry(dateISO: "2024-11-20", status: "Working - float switch cleaned", notes: "Cleared debris")
        ]
        save()
    }
